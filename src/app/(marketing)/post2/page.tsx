      ...
      <div className="container mx-auto p-6">
        ...
        <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg">
          ...
          <div className="w-full md:w-1/2">
            <img
              src="https://dynamic-blog-gamma.vercel.app/_next/image?url=%2Fnextjs15-1.jpg&w=640&q=75" // Replace with your image URL
              alt="Post Image"
          ...
          <div className="w-full md:w-1/2 p-6">
            <h1 className="text-4xl font-bold text-blue-600 mb-4">Next.js 15.1</h1>
